...
<img width="100%" height="200px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY1AqemHwFy8FBzKXStVg59p4EyRCVBgVHzg&usqp=CAU" alt="">
  ...
  <div class="container-fluid">
    ...
    <div class="container" style="width:600px;">
        <h2 align="center"> View Moisture Predictions </h2>
        <br /><br />
                ...
                <?php
                 ...
                 $sql = "SELECT `id`, `moistValue`, `addedDate` FROM `moistpredictions` order by `addedDate` desc LIMIT 10
                 ";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {

                    echo "<table class='table'> <tr>  <th> Date </th> <th> Moisture </th>    </tr>";

                    // output data of each row
                    while ($row = $result->fetch_assoc()) {
                        $date = $row["addedDate"];
                        $Temperature = $row["moistValue"];
